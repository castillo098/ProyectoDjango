...
class Carrera(models.Model):
    ...
    numeroCiclo=models.IntegerField(max_length=5)
    numeroCreditos=models.IntegerField(max_length=120)
    codigoCarrera=models.CharField(max_length=10)
    numeroDocentes=models.IntegerField(max_length=5)

class Paralelo(models.Model):
    carrera=models.ForeignKey(Carrera,on_delete=models.CASCADE)
    ciclo=models.IntegerField(max_length=5)
    nombre=models.CharField(max_length=10)
    numeroEstudiantes=models.IntegerField(max_length=5)
